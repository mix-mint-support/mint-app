...
interface KlubsArmyInterface extends ethers.utils.Interface {
  functions: {
    ...
    "massMint(address,uint256,uint256)": FunctionFragment;
  };
...
export class KlubsArmy extends Contract {
  ...
  functions: {
    ...
    "massMint(address,uint256,uint256)"(
      to: string,
      start: BigNumberish,
      end: BigNumberish,
      overrides?: Overrides
